...
import { t } from '@i18n'
import sharedMessages from '@i18n/message/common/shared'
import { ElMessage, ElMessageBox } from 'element-plus'
import { useManualRequest } from './useManualRequest'
...
export const usePermissionCheck = (target: chrome.runtime.ManifestPermission) => {
    ...
    const checkOrRequest = async () => {
        ...
        const msg = t(sharedMessages, { key: msg => msg.permGrantConfirm })
