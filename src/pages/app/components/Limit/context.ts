...
export const useLimitTable = () => useProvider<Context, 'list' | 'table' | 'empty' | 'refresh' | 'deleteRow' | 'changeEnabled' | 'changeDelay' | 'changeLocked'>(
    NAMESPACE, 'list', 'table', 'empty', 'refresh', 'deleteRow', 'changeEnabled', 'changeDelay', 'changeLocked'
)
