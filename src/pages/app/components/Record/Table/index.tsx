...
import { ElLink, ElTable, ElTableColumn, ElText, ElTooltip, RenderRowData, type TableInstance } from "element-plus"
                    ...
                    >
                        ...
                        {visible.value.date && (
                            <ElTableColumn
                                ...
                                sortable="custom"
                            >
                                {({ row }: RenderRowData<timer.stat.Row>) => cvt2LocaleTime(row.date)}
                            </ElTableColumn>
                        )}
                        {visible.value.site && <>
                            <HostColumn />
