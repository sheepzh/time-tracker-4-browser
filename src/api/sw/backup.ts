...
export const clearBackup = (cid: string) => sendMsg2Runtime('backup.clear', cid)

export const queryBackup = (param: timer.backup.RemoteQuery) => sendMsg2Runtime('backup.query', param)

export const previewBackup = (param: timer.backup.RemoteQuery) => sendMsg2Runtime('backup.preview', param)
