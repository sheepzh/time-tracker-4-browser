...
import limitDatabase from "@/background/database/limit-database"
...
import whitelistDatabase from "@/background/database/whitelist-database"
 ...
 */
class Immigration {
    private browserMigratables: BrowserMigratable[]
