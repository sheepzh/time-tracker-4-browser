import BaseDatabase from '@/background/database/common/base-database'
import { REMAIN_WORD_PREFIX } from '@/background/database/common/constant'
...
export class ClassicStatDatabase extends BaseDatabase implements StatDatabase {
    ...
    async deleteByGroup(param: timer.stat.SiteDeleteByGroup): Promise<void> {
