...
declare namespace chrome {
    namespace runtime {
        ...
        > & {
            ...
            // see https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions.json/sidebar_action
            sidebar_action?: Partial<Pick<ManifestAction, 'default_icon' | 'default_title'>> & {
