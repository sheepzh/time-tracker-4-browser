import { zeroResult, zeroRow } from '../../../src/background/database/stat-database/common'
import { IDBStatDatabase } from '../../../src/background/database/stat-database/idb'
...
describe('stat-database/idb', () => {
    ...
    test('delete', async () => {
        ...
        await db.deleteByHost({ host: GITHUB })
        expect(await db.get(GITHUB, '20240603')).toEqual(zeroRow(GITHUB, '20240603'))

        await db.deleteByGroup({ groupId: GROUP_1 })
